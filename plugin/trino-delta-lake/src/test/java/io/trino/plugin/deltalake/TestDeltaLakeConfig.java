...
public class TestDeltaLakeConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(DeltaLakeConfig.class)
                ...
                .setCreateTableWithExistingLocationEnabled(false)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("delta.create-table-with-existing-location.enabled", "true")
        ...
        DeltaLakeConfig expected = new DeltaLakeConfig()
                ...
                .setCreateTableWithExistingLocationEnabled(true)
