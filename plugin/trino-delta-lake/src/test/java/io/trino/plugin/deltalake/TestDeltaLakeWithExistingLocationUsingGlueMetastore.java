...
public class TestDeltaLakeWithExistingLocationUsingGlueMetastore
        extends BaseDeltaLakeCreateTableWithExistingLocation
{
    private static final Logger LOG = Logger.get(TestDeltaLakeWithExistingLocationUsingGlueMetastore.class);
            ...
            throws Exception
    {
        ...
        queryRunner.createCatalog(
                ...
                ImmutableMap.<String, String>builder()
                        ...
                        .put(CREATE_TABLE_WITH_EXISTING_LOCATION_ENABLED, "true")
                        .buildOrThrow());
