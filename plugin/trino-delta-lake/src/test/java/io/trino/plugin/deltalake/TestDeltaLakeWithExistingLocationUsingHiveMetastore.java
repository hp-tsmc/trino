...
import static io.trino.plugin.deltalake.DeltaLakeConfig.CREATE_TABLE_WITH_EXISTING_LOCATION_ENABLED;
import static io.trino.plugin.deltalake.DeltaLakeConnectorFactory.CONNECTOR_NAME;
import static io.trino.plugin.hive.HiveTestUtils.HDFS_ENVIRONMENT;
import static io.trino.testing.TestingSession.testSessionBuilder;

public class TestDeltaLakeWithExistingLocationUsingHiveMetastore
        extends BaseDeltaLakeCreateTableWithExistingLocation
{
    private static final Logger LOG = Logger.get(TestDeltaLakeWithExistingLocationUsingHiveMetastore.class);
            ...
            throws Exception
    {
        ...
        connectorProperties.putIfAbsent(CREATE_TABLE_WITH_EXISTING_LOCATION_ENABLED, "true");
